...
st.markdown("<h1 style='text-align: center; color: #8AB4F8; font-size: 1.9rem; font-weight: 800; margin-top: -10px; margin-bottom: 8px; letter-spacing: -0.5px;'>Magic S-RIM 가치 평가 모델</h1>", unsafe_allow_html=True)
